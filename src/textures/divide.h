...
#ifndef PBRT_TEXTURES_DIVIDE_H
#define PBRT_TEXTURES_DIVIDE_H
...
class DivideTexture : public Texture<T2> {
public:
    // ScaleTexture Public Methods
    DivideTexture(Reference<Texture<T1> > t1, Reference<Texture<T2> > t2)
        : tex1(t1), tex2(t2) { }
